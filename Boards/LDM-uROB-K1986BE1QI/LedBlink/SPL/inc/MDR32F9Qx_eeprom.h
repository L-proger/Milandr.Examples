...
__RAMFUNC uint8_t EEPROM_ReadByte(uint32_t Address, EEPROM_Mem_Bank BankSelector) __RAMFUNCSECTION;
__RAMFUNC uint16_t EEPROM_ReadHalfWord(uint32_t Address, EEPROM_Mem_Bank BankSelector) __RAMFUNCSECTION;
__RAMFUNC uint32_t EEPROM_ReadWord(uint32_t Address, EEPROM_Mem_Bank BankSelector) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_ErasePage(uint32_t Address, EEPROM_Mem_Bank BankSelector) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_EraseAllPages(EEPROM_Mem_Bank BankSelector) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_ProgramByte(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_ProgramHalfWord(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_ProgramWord(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data) __RAMFUNCSECTION;
__RAMFUNC void EEPROM_UpdateDCache(void) __RAMFUNCSECTION;
